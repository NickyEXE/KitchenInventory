...
class IngredientsTest < ApplicationSystemTestCase
  ...
  test "creating a Ingredient" do
    ...
    fill_in "Container", with: @ingredient.container
    fill_in "Name", with: @ingredient.name
    check "Perishable" if @ingredient.perishable
    fill_in "Quantity", with: @ingredient.quantity
    fill_in "Sub kind", with: @ingredient.sub_kind
    fill_in "Kind", with: @ingredient.kind
